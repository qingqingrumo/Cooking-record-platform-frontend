  ...
  <div id="userUpdatePage">
    ...
    <a-form layout="vertical" :model="userForm" @finish="handleSubmit">
      <a-form-item label="Avatar" name="userAvatar">
        <a-input v-model:value="userForm.userAvatar" placeholder="Enter avatar URL" />
      </a-form-item>
      <a-form-item label="Username" name="userName">
        <a-input v-model:value="userForm.userName" placeholder="Enter username" />
      </a-form-item>
      <a-form-item label="Profile" name="userProfile">
        <a-textarea v-model:value="userForm.userProfile" placeholder="Enter profile"
